...
import cn.medigical.publish.pojo.dictionary.ConfigLiquidTypes;

import java.util.List;

@Service
public class ConfigLiquidTypesDao extends BaseDao<ConfigLiquidTypes> {
    public  boolean remove_huifu(ConfigLiquidTypes configDelivery) {
    ...
    @Override
    public List<ConfigLiquidTypes> getAll() {
        return super.getAll();
    }

    public List<ConfigLiquidTypes> getIsTrue() {
        Criteria criteria = getCriteria();
        criteria.and("Deleted").is(false);
        return find(criteria);
    }

    public List<ConfigLiquidTypes> getIsFalse() {
        Criteria criteria = getCriteria();
    ...
    @Override
    public  boolean remove(ConfigLiquidTypes configDelivery) {
