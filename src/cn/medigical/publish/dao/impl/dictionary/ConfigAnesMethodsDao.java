...
@Service
public class ConfigAnesMethodsDao extends BaseDao<ConfigAnesMethods> {

    public  boolean remove_huifu(ConfigAnesMethods configDelivery) {
    ...
    @Override
    public List<ConfigAnesMethods> getAll() {
        return super.getAll();
    }

    public List<ConfigAnesMethods> getIsTrue() {
        Criteria criteria = getCriteria();
        criteria.and("Deleted").is(false);
        return find(criteria);
    }

    public ConfigAnesMethods getName(String name) {
        Criteria criteria = getCriteria();
    ...
    public ConfigAnesMethods getIsCode(String code) {
        Criteria criteria = getCriteria();
        criteria.and("Code").is(code);
        return findOne(criteria);
    }

    public List<ConfigAnesMethods> getIsFalse() {
        Criteria criteria = getCriteria();
    ...
    @Override
    public  boolean remove(ConfigAnesMethods configDelivery) {
