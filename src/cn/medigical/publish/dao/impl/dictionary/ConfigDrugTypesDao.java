...
import cn.medigical.publish.pojo.dictionary.ConfigDrugTypes;

import java.util.List;

@Service
public class ConfigDrugTypesDao extends BaseDao<ConfigDrugTypes> {
    public  boolean remove_huifu(ConfigDrugTypes configDelivery) {
    ...
    @Override
    public List<ConfigDrugTypes> getAll() {
        return super.getAll();
    }

    public List<ConfigDrugTypes> getIsTrue() {
        Criteria criteria = getCriteria();
        criteria.and("Deleted").is(false);
        return find(criteria);
    }

    public List<ConfigDrugTypes> getIsFalse() {
        Criteria criteria = getCriteria();
    ...
    public ConfigDrugTypes getIsCode(String code) {
        Criteria criteria = getCriteria();
    ...
    @Override
    public  boolean remove(ConfigDrugTypes configDelivery) {
    ...
    public ConfigDrugTypes getName(String name) {
        Criteria criteria = getCriteria();
        criteria.and("Name").is(name);
        Criteria criteria2 = getCriteria();
        criteria.and("Deleted").is(false);
