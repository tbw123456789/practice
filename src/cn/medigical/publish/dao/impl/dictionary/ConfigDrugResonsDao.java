...
import cn.medigical.publish.pojo.dictionary.ConfigDrugReasons;

import java.util.List;

@Service
public class ConfigDrugResonsDao extends BaseDao<ConfigDrugReasons> {

    public  boolean remove_huifu(ConfigDrugReasons configDelivery) {
    ...
    @Override
    public List<ConfigDrugReasons> getAll() {
        return super.getAll();
    }

    public List<ConfigDrugReasons> getIsTrue() {
        Criteria criteria = getCriteria();
        criteria.and("Deleted").is(false);
        return find(criteria);
    }

    public List<ConfigDrugReasons> getIsFalse() {
        Criteria criteria = getCriteria();
    ...
    @Override
    public  boolean remove(ConfigDrugReasons configDelivery) {
