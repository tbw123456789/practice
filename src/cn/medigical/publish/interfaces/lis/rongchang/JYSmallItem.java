...
public class JYSmallItem {
	  ...
	  {
	    return "JYSmallItem{no='" + this.no + '\'' + ", vlueType='" + this.vlueType + '\'' + ", code='" + this.code + '\'' + ", eName='" + this.eName + '\'' + ", cName='" + this.cName + '\'' + ", vlue='" + this.vlue + '\'' + ", unit='" + this.unit + '\'' + ", referRange='" + this.referRange + '\'' + ", abnormalFlags='" + this.abnormalFlags + '\'' + ", resultStatus='" + this.resultStatus + '\'' + ", analysisDate='" + this.analysisDate + '\'' + '}';
	  }
