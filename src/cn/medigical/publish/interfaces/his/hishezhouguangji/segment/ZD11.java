...
public class ZD11 extends AbstractSegment {

    public ZD11(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
        try {
            ...
            this.add(NM.class, false, 1, 180, new Object[]{this.getMessage()}, "患者标识列表");
            ...
            this.add(ST.class, false, 1, 180, new Object[]{this.getMessage()}, "标本部位");
