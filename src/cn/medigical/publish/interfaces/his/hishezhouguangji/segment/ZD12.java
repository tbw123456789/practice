...
public class ZD12 extends AbstractSegment {

    public ZD12(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
        try {
            ...
            this.add(CWE.class, false, 1, 180, new Object[]{this.getMessage()}, "观察方法");
            this.add(EI.class, false, 1, 180, new Object[]{this.getMessage()}, "仪器名称");
