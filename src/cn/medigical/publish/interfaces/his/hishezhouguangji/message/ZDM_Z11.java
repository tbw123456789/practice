...
import cn.medigical.publish.interfaces.his.hishezhouguangji.segment.ZD14;

public class ZDM_Z11 extends AbstractMessage {

    public ZDM_Z11() {
        this(new DefaultModelClassFactory());
    }

    public ZDM_Z11(ModelClassFactory factory) {
        super(factory);
        this.init(factory);
    }
    ...
    public ZD14 getZD14() {
        return (ZD14)this.getTyped("ZD14", ZD14.class);
    }
