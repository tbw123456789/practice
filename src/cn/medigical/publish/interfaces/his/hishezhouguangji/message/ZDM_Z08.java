...
public class ZDM_Z08 extends AbstractMessage {

    public ZDM_Z08() {
        this(new DefaultModelClassFactory());
    }

    public ZDM_Z08(ModelClassFactory factory) {
        super(factory);
        this.init(factory);
    }
    ...
    public ZD11 getZD11() {
        return (ZD11)this.getTyped("ZD11", ZD11.class);
    }
}
