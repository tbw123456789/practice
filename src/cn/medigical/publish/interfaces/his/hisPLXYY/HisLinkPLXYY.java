package cn.medigical.publish.interfaces.his.hisPLXYY;
...
public class HisLinkPLXYY extends HisLink {
    ...
    String dbIP = "10.10.5.1";
    String url = "jdbc:oracle:thin:@//10.10.5.1:1521/orcl";
    String username = "ZL_BCSM";
    String password = "ZL_BCSM";

    public static HisLinkPLXYY getInstance() {
        if (instance == null) {
            instance = new HisLinkPLXYY();
        }
        return instance;
    }
    ...
    private PatientLink getOperation(ResultSet rs, Connection conn, List<Account> accountList) throws SQLException {
        ...
        // 明细状态
        patientLink.getApplication().setDetailstatus(Constants.OR_STATUS_FLAG_SCHEDULED);
        // 患者状态
